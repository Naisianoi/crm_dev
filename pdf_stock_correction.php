    ...
    while ($brand_row = mysqli_fetch_assoc($brand_results)) {
        ...
        if (mysqli_num_rows($product_results) > 0) {
                ...
                border: 1px solid #e0e0e0; /* Change the color code to whatever faint color you prefer */
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th width="15%"><strong>Stock Quantity</strong></th>
                                    <th width="15%"><strong>Minimum Stock</strong></th>
                                    <th width="15%"><strong>Todays Qty</strong></th>
                                </tr>
                            </thead>
                            <tbody>';
            ...
            while ($row = mysqli_fetch_assoc($product_results)) {
                $content .= '<tr>
                                <td align="center" width="5%" style="font-size:10px; line-height:2;">' . $row['id'] . '</td>
                                <td align="left" width="50%" style="font-size:10px; line-height:2;">' . $row['name'] . '</td>
                                <td align="center" width="15%" style="font-size:10px; line-height:2;">' . $row['stock_qty'] . '</td>
                                <td align="center" width="15%" style="font-size:10px; line-height:2;">' . $row['min_stock'] . '</td>
                                <td align="center" width="15%" style="font-size:10px; line-height:2;"></td>
                            </tr>';
            }
...
while ($category_row = mysqli_fetch_assoc($category_results)) {
    ...
    while ($sub_category_row = mysqli_fetch_assoc($sub_category_results)) {
        ...
        $item_query = "SELECT id, item_name, stock_qty, min_stock
                       FROM tbl_item
        ...
        if (mysqli_num_rows($item_results) > 0) {
            ...
            while ($item_row = mysqli_fetch_assoc($item_results)) {
                $tableContent .= '<tr> 
                                    <td align="center" width="5%" style="font-size:10px; line-height:2;">' . $item_row['id'] . '</td>
                                    <td align="left" width="50%" style="font-size:10px; line-height:2;">' . $item_row['item_name'] . '</td>
                                    <td align="center" width="15%" style="font-size:10px; line-height:2;">' . $item_row['stock_qty'] . '</td>
                                    <td align="center" width="15%" style="font-size:10px; line-height:2;">' . $item_row['min_stock'] . '</td>
                                    <td align="center" width="15%" style="font-size:10px; line-height:2;"></td>
                                </tr>';
