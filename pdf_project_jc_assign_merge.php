...
$pdf_query_page1 = "SELECT id, jc_create_date, jc_assigned_to, business, commerce, jc_lead_by, jc_type, company_name, customer_name, address, 
    ...
    last_jc_type, last_assigned_to, work_statement, customer_word, project_id, project_name, project_type, project_name, site_name, site_address, site_city, site_county, site_contact_name_1, 
    site_contact_number_1, site_contact_name_2, site_contact_number_2  FROM tbl_service_jc WHERE id = $MST_ID ";
...
<table>
    <tbody>
        <tr>
            ...
            <td style="color: orange;"><br/><h3>PROJECT JOB CARD</h3></td>
...
<table class="data">
    <tbody>
        ...
        <tr>
            <td><strong>PROJECT NUMBER #: </strong> ' . $pdf_data_row_page1['project_id'] . '</td>
            ...
            <tr>
                <td><!-- Left Section (Customer Details) -->
                    <table>
                        ...
                        <tr class="data">
                            <td colspan="3"> ' . $pdf_data_row_page1['address'] . '</td>
                        </tr>
                        <tr class="data">
        ...
        <table>
            ...
            <tr class="data">
                <td colspan="4"><strong style="color: orange;">To be filled by Technician:</strong> Work Done Date:_________ Time Started:______Time Completed:_______</td>  
            </tr>
            <tr class="data">
