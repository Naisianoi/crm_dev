    ...
    <div class="container" style="padding-top: 0px; margin-left: 0px; padding-bottom: 0px;">
      <div class="tab-content">
        <div id="brand" class="tab-pane in active">
          <h1 style="padding-top: 0px;">ACTIVITY</h1><br>

          <!-- START FORM -->
          <form action="performance-activity-page.php" method="post">
            <div class="row mb-3">
              ...
              <div class="col-2 d-flex align-items-end">
                <input class="form-control btn btn-info" type="submit" name="submit" value="View Activity">
              </div>
            </div>
          </form>
          <!-- END FORM -->
