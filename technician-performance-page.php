      ...
      <section>
        <div class="container" style="padding-top: 0px; margin-left: 0px; padding-bottom: 0px;">
            ...
            <div class="tab-content">
              ...
              <h1 style="padding-top: 0px;">TECHNICIAN</h1><br>
              
             
                <form action="performance-technician-page.php" method="post">
                    <div class="row mb-3">
                        ...
                        <div class="col-3">
                            ...
                            <select class="form-select" name="technician"  id="technician" class="technician">
                        ...
                        <div class="col-2">
                            ...
                            <input class="form-control btn btn-info" type="submit" name="submit" value="View Technician">
                        </div>
