...
<table>
    <tbody>
        <tr>
            ...
            <td style="color: #0D6EFD;"><br/><h3>SERVICE JOB CARD</h3></td>
...
<table class="data">
    <tbody>
        ...
        <tr>
            <td><strong style="color: #0D6EFD;">Last JC:</strong> {$pdf_data_row_page1['last_jc_number']}</td>
            <td><strong style="color: #0D6EFD;">JC Date:</strong> {$pdf_data_row_page1['last_jc_date']}</td>
            <td><strong style="color: #0D6EFD;">Assigned To:</strong> {$pdf_data_row_page1['last_assigned_to']}</td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4"><strong style="color: #0D6EFD;">To be filled by technician:</strong> Work Done Date: _________ Time Start: ______ Time Completed: ______</td>
        </tr>
        <tr><td colspan="8">Job Description/Findings: </td>

        </tr><br/><br/><br/><br/><br/><br/>
        <tr>
            <td colspan="2">Flow of Water (500ml): <strong style="color: #0D6EFD;">Pure Water:</strong> ______ sec</td>
            <td colspan="1"><strong style="color: #0D6EFD;">Reject Water:</strong> ______ sec</td>
        </tr>
        <tr>
            <td colspan="4" style="border-bottom: 0.02px dotted #222;"></td>
        </tr><br/>
        <tr>
            ...
            <td colspan="2"><strong style="color: #0D6EFD;">Amount Agreed:</strong> <strong>KES {$pdf_data_row_page1['amount']}</strong></td>
        </tr>
        <tr>
            <td colspan="4" style="border-bottom: 0.02px dotted #222;"></td>
        </tr><br/>
