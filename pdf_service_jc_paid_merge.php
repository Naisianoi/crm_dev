...
if ($count_page1 > 0) {
    ...
    $content_page1 = '
        ...
        <tbody>
        <tr class="data">
            <td><strong>JOB CARD D: </strong> ' . $pdf_data_row_page1['id'] . '</td>
        ...
        <tr class="data">
            <td><strong style="color: #0D6EFD;">Business: </strong> ' . $pdf_data_row_page1['business'] . '</td>
            <td><strong style="color: #0D6EFD;">Commerce:</strong> ' . $pdf_data_row_page1['commerce'] . '</td>
            <td><strong style="color: #0D6EFD;">Lead By:</strong> ' . $pdf_data_row_page1['jc_lead_by'] . '</td>
        </tr>
        <tr class="data">
        ...
        <tr class="data">
            <td><strong>Area:</strong> ' . $pdf_data_row_page1['area'] . '</td>
            <td><strong>County:</strong> ' . $pdf_data_row_page1['county'] . '</td>
            <td><strong>City:</strong> ' . $pdf_data_row_page1['city'] . '</td>
        </tr>
        <tr class="data">
            <td><strong>Contact:</td>
        </tr>
        <tr class="data">
            <td><strong>Person 1:</strong> ' . $pdf_data_row_page1['contact_name_1'] . '</td>
            <td><strong>Contact No.1:</strong> ' . $pdf_data_row_page1['contact_number_1'] . '</td>
            <td><strong>Company Name:</strong> ' . $pdf_data_row_page1['company_name'] . '</td>
        </tr>
        <tr class="data">
            <td><strong>Person 2:</strong> ' . $pdf_data_row_page1['contact_name_2'] . '</td>
            <td><strong>Contact No.2:</strong> ' . $pdf_data_row_page1['contact_number_2'] . '</td>
        ...
        <tr class="data">
            <td colspan="2"><strong style="color: #0D6EFD;">Product:</strong> ' . $pdf_data_row_page1['product_name'] . '</td>
            <td><strong style="color: #0D6EFD;">Brand:</strong> ' . $pdf_data_row_page1['brand'] . '</td>
        </tr>
        <tr class="data">
            <td colspan="4" style="border-bottom: 0.02px dotted #222;"></td>
        </tr><br/>
        <tr class="data">
            ...
            <td><strong style="color: #0D6EFD;">Job Type:</strong> ' . $pdf_data_row_page1['jc_type'] . '</td>
            <td><strong style="color: #0D6EFD;">Last JC Type:</strong> ' . $pdf_data_row_page1['last_jc_type'] . '</td>
        </tr>
        <tr class="data">
            <td><strong style="color: #0D6EFD;">Last JC No: </strong>' . $pdf_data_row_page1['last_jc_number'] . '</td>
            <td><strong style="color: #0D6EFD;">Last JC Date: </strong>' . $pdf_data_row_page1['last_jc_date'] . '</td>
            <td><strong style="color: #0D6EFD;">Last Assigned:</strong>' . $pdf_data_row_page1['last_assigned_to'] . '</td>
        </tr>
        <tr class="data">
        ...
        <tr class="data">
            <td colspan="4"><strong style="color: #0D6EFD;">To be filled by Technician:</strong> Work Done Date: <strong>' . $pdf_data_row_page1['work_done_date'] . '</strong> Time Started:______Time Completed:_______</td>
        </tr>
        <tr class="data">
        ...
        <tr class="data">
            <td colspan="2">Flow of Water (500ml): <strong style="color: #0D6EFD;">Pure Water:</strong> <strong>' . $pdf_data_row_page1['flow_pure'] . '</strong>Sec. </td>
            <td colspan="1"><strong style="color: #0D6EFD;">Reject Water:</strong> <strong>' . $pdf_data_row_page1['flow_reject'] . '</strong>Sec. </td>
        </tr>
        <tr class="data">
            <td colspan="4" style="border-bottom: 0.02px dotted #222;"></td>
        </tr><br/>
        <tr class="data">
            ...
            <td colspan="1"><strong style="color: #0D6EFD;">Amount Agreed:</strong> <strong>KES ' . $pdf_data_row_page1['amount'] . '</strong></td>
        </tr>
        <tr class="data">
            <td colspan="4" style="border-bottom: 0.02px dotted #222;"></td>
        </tr><br/>
...
if ($count_page2 > 0) {
    ...
    $content_page2 .=
        ...
        <tr class="data">
            <td colspan="2"><strong>JOB CARD D: </strong> ' . $MST_ID . '</td>
        </tr><br/>
        <tr class="data">
    ...
    $content_page2 .= '<td colspan="2"><strong style="color: #0D6EFD;">PRODUCTS</strong></td>';
    $content_page2 .= '</tr>';
    $content_page2 .= '<tr class="data">';
    $content_page2 .= '<td colspan="1"><strong style="color: #0D6EFD;">Name</strong></td>';
    $content_page2 .= '<td colspan="1"><strong style="color: #0D6EFD;">Quantity</strong></td>';
    $content_page2 .= '</tr>';
    ...
    $content_page2 .= '<tr class="data">';
    $content_page2 .= '<td colspan="2"><strong style="color: #0D6EFD;">ITEMS</strong></td>';
    $content_page2 .= '</tr>';
    $content_page2 .= '<tr class="data">';
    $content_page2 .= '<td colspan="1"><strong style="color: #0D6EFD;">Name</strong></td>';
    $content_page2 .= '<td colspan="1"><strong style="color: #0D6EFD;">Quantity</strong></td>';
