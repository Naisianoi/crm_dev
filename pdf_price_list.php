...
$content = '<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
    ...
    while ($brand_row = mysqli_fetch_assoc($brand_results)) {
        ...
        $product_query = "SELECT brand, name, stock_qty, price_list_price 
                            FROM tbl_product 
        ...
        if (mysqli_num_rows($product_results) > 0) {
                ...
                border: 1px solid #e0e0e0; /* Change the color code to whatever faint color you prefer */
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th width="20%"><strong>Brand</strong></th>
            ...
            while ($product_row = mysqli_fetch_assoc($product_results)) {
                $content .= '<tr>
                                ...
                                <td align="left" width="50%" style="font-size:12px">' . $product_row['name'] . '</td>
                                <td align="center" width="20%" style="font-size:12px">' . $product_row['brand'] . '</td>
                                <td align="center" width="15%" style="font-size:12px">' . $product_row['stock_qty'] . '</td>
                                <td align="right" width="15%" style="font-size:12px">' . number_format($product_row['price_list_price']) . '</td>
                            </tr>';
            }
...
while ($category_row = mysqli_fetch_assoc($category_results)) {
    ...
    while ($sub_category_row = mysqli_fetch_assoc($sub_category_results)) {
        ...
        $item_query = "SELECT brand, item_name, stock_qty, price_list_price
                       FROM tbl_item
        ...
        if (mysqli_num_rows($item_results) > 0) {
            ...
            while ($item_row = mysqli_fetch_assoc($item_results)) {
                $tableContent .= '<tr>
                                ...
                                <td align="left" width="50%" style="font-size:12px">' . $item_row['item_name'] . '</td>
                                <td align="center" width="20%" style="font-size:12px">' . $item_row['brand'] . '</td>
                                <td align="center" width="15%" style="font-size:12px">' . $item_row['stock_qty'] . '</td>
                                <td align="right" width="15%" style="font-size:12px">' . number_format($item_row['price_list_price']) . '</td>
                            </tr>';
