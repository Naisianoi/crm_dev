...
let customerTypeSelect = document.getElementById('edit_customer_type_select');
...
// Get the customer type select element
let customerTypeResellerSelect = document.getElementById('edit_customer_type_select');
...
// Get the customer type select element
let commerceSelect = document.getElementById('edit_commerce_select');
...
$(document).ready(function() {
  ...
  $('#edit_product_select').change(function() {
      ...
      $.ajax({
          ...
          success: function(response) {
            // console.log(response);
              ...
              $('#edit_brand_input').val(response.brand);
              $('#edit_business_input').val(response.business);
