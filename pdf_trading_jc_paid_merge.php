...
$pdf_query_page1 = "SELECT id, jc_create_date, jc_assigned_to, business, commerce, jc_lead_by, jc_type, customer_type, company_name, customer_name, address, 
                    ...
                    last_assigned_to, last_jc_type, work_statement, customer_word, amount, work_done_date, job_finding, work_satisfactory, client_sign, jc_conclude_date,
...
if ($count_page1 > 0) {
    ...
    $content_page1 = '
        ...
        <tr class="data">
            <td><strong style="color: green;">Last JC No: </strong>' . $pdf_data_row_page1['last_jc_number'] . '</td>
            <td><strong style="color: green;">Last JC Date: </strong>' . $pdf_data_row_page1['last_jc_date'] . '</td>
            <td><strong style="color: green;">Last Assigned:</strong>' . $pdf_data_row_page1['last_assigned_to'] . '</td>
        </tr>
        <tr class="data">
        ...
        <tr class="data">
            <td colspan="4"><strong style="color: green;">To be filled by Technician:</strong> Work Done Date: <strong>' . $pdf_data_row_page1['work_done_date'] . '</strong> Time Started:______Time Completed:_______</td>
        </tr>
        <tr class="data">
        ...
        <tr class="data">
            ...
            <td colspan="1"><strong style="color: green;">Amount Agreed:</strong> <strong>KES ' . $pdf_data_row_page1['amount'] . '</strong></td>
        </tr>
        <tr class="data">
            <td colspan="4" style="border-bottom: 0.02px dotted #222;"></td>
        </tr><br/>
