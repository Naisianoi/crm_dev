...
if (mysqli_num_rows($pdf_results_project) > 0) {
    $content_project = '<h2 style="text-align: center;">COLLECTION REPORT (PROJECT AND AMC) - DWS</h2>';
    ...
    $pdf->writeHTML('<h2 style="text-align: center;">COLLECTION REPORT (PROJECT AND AMC) - IWT</h2><p style="text-align: center;">No records found for the selected date range.</p>', true, false, true, false, '');
}
