...
if (isset($_SESSION['username'])) {
    ...
    // Trigger ONLY between 6AM and 9AM
    if ($currentHour >= 7 && $currentHour <= 9) {
        // Check if report for yesterday already exists
        $check = mysqli_query($conn, "SELECT id FROM tbl_daily_status WHERE daily_status_date = '$yesterday'");
...
if (isset($_SESSION['username'])) {
    ...
    if ($user && $user['user_type'] === 'admin') {
        ...
        // Trigger report only after 23:30 
        if ($currentTime >= '23:30') {
            $check = mysqli_query($conn, "SELECT id FROM tbl_daily_status WHERE daily_status_date = '$today'");
            if (mysqli_num_rows($check) === 0) {
                include('generate_daily_report.php');
            }
        }
                                ...
                                if ($userType === "admin" || $userType === "manager") {
                                    ...
                                    <li>
                                        ...
                                        <ul class="collapse nav flex-column ms-1" id="submenu3" data-bs-parent="#menu">
                                            ...
                                            <li class="subcategory">
                                                <a href="collection-report-page-st.php"  class="nav-link px-0">Collection (S&T)</a>
                                            </li>
                                            <li class="subcategory">
                                                <a href="collection-report-page-pa.php"  class="nav-link px-0">Collection (P&A)</a>
                                            </li>
                                            <li class="subcategory">
                                           ...
                                           <li class="subcategory">
                                                <a href="stock-movement-page-p.php"  class="nav-link px-0">Stock Movement (P)</a>
                                            </li>
                                            <li class="subcategory">
                                                <a href="stock-movement-page-i.php"  class="nav-link px-0">Stock Movement (I)</a>
                                            </li>
                                            <li class="subcategory">
                                ...
                                <a href="#submenu5" data-bs-toggle="collapse" class="nav-link px-0 align-middle ">
                                    <b>Performance</b></a>
                                        <ul class="collapse nav flex-column ms-1" id="submenu5" data-bs-parent="#menu">
                                            <i><li class="subcategory">
                                                <a href="jc-costing-page.php"  class="nav-link px-0">JC Costing</a>
                                            </li>
                                            <li class="subcategory">
                                                <a href="technician-performance-page.php" class="nav-link px-0">Technician</a>
                                            </li>
                                            <li class="subcategory">
                                                <a href="activity-performance-page.php" class="nav-link px-0">Activity</a>
                                            </li>
                                            <li class="subcategory">
                                                <a href="view_daily_status_report.php" class="nav-link px-0">Daily Status</a>
                                            </li>
                                        </ul>
                            </li> 
